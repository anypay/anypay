...
class TxForwarder {
    ...
    calculateFee() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                this.fee = yield lib.getSmartFee(12);
                return this.fee;
            }
            catch (error) {
    ...
    broadcastOutput() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield lib.broadcastSignedTx(this.outputTx);
    ...
    publishForwarded() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.config.amqpChannel.publish('anypay.router', 'btc.forwarded', Buffer.from(JSON.stringify({
