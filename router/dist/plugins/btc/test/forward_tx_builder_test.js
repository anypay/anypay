...
describe("TxForwarder", () => {
    it("should get the address route from the hex of its transaction", () => __awaiter(void 0, void 0, void 0, function* () {
        let inputTx = {
            amount: 0,
            confirmations: 1572,
        ...
        let route = yield lib.getAddressRouteFromTx(new btc.Transaction(inputTx.hex));
...
//# sourceMappingURL=forward_tx_builder_test.js.map