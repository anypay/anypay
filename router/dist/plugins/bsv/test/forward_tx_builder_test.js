...
describe("TxForwarder", () => {
    it("should get the address route from  hex of a transaction", () => __awaiter(void 0, void 0, void 0, function* () {
        let inputTx = {
            amount: 0.00062,
            confirmations: 1,
        ...
        let route = yield lib.getAddressRouteFromTx(new bsv.Transaction(inputTx.hex));
        console.log(route);
