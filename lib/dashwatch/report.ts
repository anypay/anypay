...
async function sumMerchantsDashBackPaid(start, end) {
  ...
  cash_back_merchant_payments where currency="DASH" and "createdAt" > '${start}' and "createdAt" <
  '${end}'`);
...
async function sumCustomersDashBackPaid(start, end) {
  ...
  cash_back_customer_payments where currency="DASH" and "createdAt" > '${start}' and "createdAt" <
  '${end}'`);
...
async function sumDashBackTransactions(start, end) {
  ...
  cash_back_merchant_payments where currency="DASH" "createdAt" > '${start}' and "createdAt" <
  '${end}'`);
