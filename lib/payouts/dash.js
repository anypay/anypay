 ...
 * @apiGroup Addresses
 *
 * @apiParam {String} address New Dash Address
 *
 * @apiError 500 InternalError Internal Server Error. Server cannot process the request for an unknown reason.
 *
 * @apiSuccess {String} address New Dash Address
 *
