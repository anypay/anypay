...
export async function index(request: AuthenticatedRequest | Request, h: ResponseToolkit) {
  ...
  let webhooks = await listForAccount((request as AuthenticatedRequest).account, {
...
export async function test(request: AuthenticatedRequest | Request, h: ResponseToolkit) {
...
export async function attempt(request: AuthenticatedRequest | Request, h: ResponseToolkit) {
