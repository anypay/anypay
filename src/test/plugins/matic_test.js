...
describe('MATIC', () => {
    it('should find the plugin for MATIC', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, chai_1.expect)(plugin.currency).to.be.equal('MATIC');
    ...
    it('#getPayments should accept a txid and return a parsed MATIC payment', () => __awaiter(void 0, void 0, void 0, function* () {
        let plugin = yield (0, plugins_1.find)({ chain: 'MATIC', currency: 'MATIC' });
        ...
        (0, chai_1.expect)(payment.amount).to.be.equal(4.9801);
        (0, chai_1.expect)(payment.chain).to.be.equal('MATIC');
        (0, chai_1.expect)(payment.currency).to.be.equal('MATIC');
...
//# sourceMappingURL=matic_test.js.map