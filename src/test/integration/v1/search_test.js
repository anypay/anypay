...
describe("Searching", () => __awaiter(void 0, void 0, void 0, function* () {
    it('should find an invoice by txid with the library', () => __awaiter(void 0, void 0, void 0, function* () {
        let invoice = yield (0, utils_1.newInvoice)({ account: utils_1.account, amount: 0.52 });
        ...
        const { result } = yield utils_1.server.inject({
            method: 'POST',
            url: '/v1/api/search',
            headers: {
        ...
        (0, utils_1.expect)(result.result.length).to.be.equal(1);
        const { hash } = result.result[0].value;
        (0, utils_1.expect)(hash).to.be.equal(tx.tx_id);
    }));
}));
