...
describe("Plugins", () => {
    ...
    describe('BCH', () => {
        it('should find the plugin for BCH', () => __awaiter(void 0, void 0, void 0, function* () {
            let plugin = yield (0, plugins_1.find)({ currency: 'BCH', chain: 'BCH' });
        ...
        it('#getConfirmation should return block data for confirmed transaction', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            let { confirmations, confirmation_hash, confirmation_height, confirmation_date } = yield plugin.getConfirmation(txid);
            (0, chai_1.expect)(confirmations).to.be.greaterThan(0);
    ...
    describe('BTC', () => {
        it('should find the plugin for BTC', () => __awaiter(void 0, void 0, void 0, function* () {
            let plugin = yield (0, plugins_1.find)({ chain: 'BTC', currency: 'BTC' });
            assert.strictEqual(plugin.currency, 'BTC');
            assert.strictEqual(plugin.chain, 'BTC');
            assert.strictEqual(plugin.decimals, 8);
            (0, chai_1.expect)(plugin.broadcastTx).to.be.a('function');
        }));
        it('#getConfirmation should return block data for confirmed transaction', () => __awaiter(void 0, void 0, void 0, function* () {
            let plugin = yield (0, plugins_1.find)({ chain: 'BTC', currency: 'BTC' });
            ...
            let { confirmations, confirmation_hash, confirmation_height, confirmation_date } = yield plugin.getConfirmation(txid);
            (0, chai_1.expect)(confirmations).to.be.greaterThan(0);
            (0, chai_1.expect)(confirmation_hash).to.be.equal('00000000000000000003e7cb4d095fb3a4fb8db43196afab6408c022e73ec85f');
            (0, chai_1.expect)(confirmation_height).to.be.equal(789613);
            (0, chai_1.expect)(confirmation_date).to.be.a('date');
        }));
    });
    describe('DASH', () => {
        it('should find the plugin for DASH', () => __awaiter(void 0, void 0, void 0, function* () {
            let plugin = yield (0, plugins_1.find)({ chain: 'DASH', currency: 'DASH' });
            assert.strictEqual(plugin.currency, 'DASH');
            assert.strictEqual(plugin.chain, 'DASH');
            assert.strictEqual(plugin.decimals, 8);
        }));
        it.skip('#getConfirmation should return block data for confirmed transaction', () => __awaiter(void 0, void 0, void 0, function* () {
            let plugin = yield (0, plugins_1.find)({ chain: 'DASH', currency: 'DASH' });
            let txid = '1eb4e53d410c4a7e44e6d80484756791052a0c79c35151bffb1bed970323a6b1';
            let { confirmations, confirmation_hash, confirmation_height, confirmation_date } = yield plugin.getConfirmation(txid);
            (0, chai_1.expect)(confirmations).to.be.greaterThan(0);
            (0, chai_1.expect)(confirmation_hash).to.be.equal('0000000000000008dc00e5b8eba00897b0b3e50ab0e6fe1d16818d13fe8232a1');
            (0, chai_1.expect)(confirmation_height).to.be.equal(1870467);
            (0, chai_1.expect)(confirmation_date).to.be.a('date');
        }));
    });
    describe('LTC', () => {
        it('should find the plugin for LTC', () => __awaiter(void 0, void 0, void 0, function* () {
            let plugin = yield (0, plugins_1.find)({ chain: 'LTC', currency: 'LTC' });
        ...
        it('#getConfirmation should return block data for confirmed transaction', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            let { confirmations, confirmation_hash, confirmation_height, confirmation_date } = yield plugin.getConfirmation(txid);
            (0, chai_1.expect)(confirmations).to.be.greaterThan(0);
            (0, chai_1.expect)(confirmation_hash).to.be.equal('98a2a60c30e30960296b454d69d85d1905953d571f90f2befa0f0dd7c7631d3e');
            (0, chai_1.expect)(confirmation_height).to.be.equal(2473321);
            (0, chai_1.expect)(confirmation_date).to.be.a('date');
        }));
    });
    describe('DOGE', () => {
        it('should find the plugin for DOGE', () => __awaiter(void 0, void 0, void 0, function* () {
            let plugin = yield (0, plugins_1.find)({ chain: 'DOGE', currency: 'DOGE' });
        ...
        it('#getConfirmation should return block data for confirmed transaction', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            let { confirmations, confirmation_hash, confirmation_height, confirmation_date } = yield plugin.getConfirmation(txid);
            (0, chai_1.expect)(confirmations).to.be.greaterThan(0);
            (0, chai_1.expect)(confirmation_hash).to.be.equal('d52fc7ea1b838c4ed9d9ad30c123cd18e25f842129c21a887736d3f2eef8439f');
            (0, chai_1.expect)(confirmation_height).to.be.equal(4716421);
            (0, chai_1.expect)(confirmation_date).to.be.a('date');
        }));
    });
    describe('BSV', () => {
    ...
    describe('XMR', () => {
        ...
        xit('#getConfirmation should return block data for confirmed transaction', () => __awaiter(void 0, void 0, void 0, function* () {
            let plugin = yield (0, plugins_1.find)({ chain: 'XMR', currency: 'XMR' });
    ...
    describe('MATIC', () => {
        it('should find the plugin for MATIC', () => __awaiter(void 0, void 0, void 0, function* () {
            let plugin = yield (0, plugins_1.find)({ chain: 'MATIC', currency: 'MATIC' });
        ...
        it('#getConfirmation should return block data for confirmed transaction', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            let { confirmations, confirmation_hash, confirmation_height, confirmation_date } = yield plugin.getConfirmation(txid);
            (0, chai_1.expect)(confirmations).to.be.greaterThan(0);
            (0, chai_1.expect)(confirmation_hash).to.be.equal('0xde5a4703ca10f3176be78ee832881bfc3bae5600f06924f82ab4951b29271573');
            (0, chai_1.expect)(confirmation_height).to.be.equal(42680415);
            (0, chai_1.expect)(confirmation_date).to.be.a('date');
        }));
    });
    describe('AVAX', () => {
        ...
        it('#getConfirmation should return block data for confirmed transaction', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            let { confirmations, confirmation_hash, confirmation_height, confirmation_date } = yield plugin.getConfirmation(txid);
            (0, chai_1.expect)(confirmations).to.be.greaterThan(0);
            (0, chai_1.expect)(confirmation_hash).to.be.equal('0x195e761cecea1cf5d9faf4540a87b685449439f9df65216536b1dddbd1ec3544');
            (0, chai_1.expect)(confirmation_height).to.be.equal(29994194);
            (0, chai_1.expect)(confirmation_date).to.be.a('date');
        }));
    });
    describe('SOL', () => {
        it.skip('should find the plugin for SOL', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it.skip('#getConfirmation should return block data for confirmed transaction', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(confirmation_height).to.be.equal(193936012);
            (0, chai_1.expect)(confirmation_date).to.be.a('date');
        }));
    });
    describe('TRON', () => {
        it.skip('should find the plugin for TRON', () => __awaiter(void 0, void 0, void 0, function* () {
            let plugin = yield (0, plugins_1.find)({ chain: 'TRON', currency: 'TRON' });
        ...
        it.skip('#getConfirmation should return block data for confirmed transaction', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            let { confirmations, confirmation_hash, confirmation_height, confirmation_date } = yield plugin.getConfirmation(txid);
            (0, chai_1.expect)(confirmations).to.be.greaterThan(0);
            (0, chai_1.expect)(confirmation_hash).to.be.equal('00000000030c5eb3e4e7d51c0ed80a2456b9142f41426a94daf601779dca2777');
            (0, chai_1.expect)(confirmation_height).to.be.equal(51142323);
            (0, chai_1.expect)(confirmation_date).to.be.a('date');
        }));
    });
    describe('XRP', () => {
    ...
    */
    describe('USDC', () => {
        describe('USDC.ETH', () => {
            it('should find the plugin for USDC.ETH', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        describe('USDC.AVAX', () => {
            it('should find the plugin for USDC.AVAX', () => __awaiter(void 0, void 0, void 0, function* () {
                let plugin = yield (0, plugins_1.find)({ chain: 'AVAX', currency: 'USDC' });
                assert.strictEqual(plugin.currency, 'USDC');
                assert.strictEqual(plugin.chain, 'AVAX');
    ...
    describe('USDT', () => {
        describe('USDT.ETH', () => {
            it('should find the plugin for USDT.ETH', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('#getConfirmation should return block data for confirmed transaction', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                let { confirmations, confirmation_hash, confirmation_height, confirmation_date } = yield plugin.getConfirmation(txid);
                (0, chai_1.expect)(confirmations).to.be.greaterThan(0);
                (0, chai_1.expect)(confirmation_hash).to.be.equal('0x444e405425339f6a17cba63c822af4a72f6337542db5642592fbb31cfd8d801d');
                (0, chai_1.expect)(confirmation_height).to.be.equal(17247170);
                (0, chai_1.expect)(confirmation_date).to.be.a('date');
            }));
        });
        describe('USDT.MATIC', () => {
            ...
            it('#getConfirmation should return block data for confirmed transaction', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                let { confirmations, confirmation_hash, confirmation_height, confirmation_date } = yield plugin.getConfirmation(txid);
                (0, chai_1.expect)(confirmations).to.be.greaterThan(0);
                (0, chai_1.expect)(confirmation_hash).to.be.equal('0xd51998fb091e2cce9e3684f5f45cc56a2deb09bd0f51514b426abd04be2f85d4');
                (0, chai_1.expect)(confirmation_height).to.be.equal(42680347);
                (0, chai_1.expect)(confirmation_date).to.be.a('date');
            }));
        });
        describe('USDT.AVAX', () => {
            it('should find the plugin for USDT.AVAX', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('#getConfirmation should return block data for confirmed transaction', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                let { confirmations, confirmation_hash, confirmation_height, confirmation_date } = yield plugin.getConfirmation(txid);
                (0, chai_1.expect)(confirmations).to.be.greaterThan(0);
                (0, chai_1.expect)(confirmation_hash).to.be.equal('0x91fffe943de27a50c45c09fe6d90418af26fab4904f09cd497475f123ee877df');
                (0, chai_1.expect)(confirmation_height).to.be.equal(29994293);
                (0, chai_1.expect)(confirmation_date).to.be.a('date');
            }));
        });
        /*
...
//# sourceMappingURL=plugins_test.js.map