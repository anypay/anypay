...
export interface ERC20TransferInstruction {
...
export interface UTXOTransferInstruction {
  outputs: {
    address: string;
    amount: number;
  }[]; 
...
export type Instruction = ERC20TransferInstruction | UTXOTransferInstruction | any
